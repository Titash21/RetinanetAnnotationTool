...
# RetinaNetAnnotationTool
Tool to annotate images to create an input for Retinanet
...
```
### Create 00x (x being a number) folder in Images folder and put your class one images
